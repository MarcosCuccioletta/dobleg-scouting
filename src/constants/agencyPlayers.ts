...
export const BASE_AGENCY_PLAYERS: AgencyPlayer[] = [
  ...
  { shortName: 'J. López', fullName: 'Julián López', image: 'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcR06ZxgTLDKhTeyGv2BZ8E6SIiUE14T7F_eTpFhz8Rja7XmHw', contractEnd: '31/12/2026', marketValue: '€1.20m', team: 'Defensa y Justicia', apiTeamId: 442, isReserve: false, position: 'Volante central' },
  ...
  { shortName: 'M. Vera', fullName: 'Mauricio Vera', image: 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSHFjZ591GzSnBG525pUcTExQgvHYyltJKa_nRsLERsiHgtlw', contractEnd: '31/12/2026', marketValue: '€600k', team: 'Bhayangkara FC', apiTeamId: 2443, isReserve: false },
  ...
  { shortName: 'S. Cartagena', fullName: 'Santiago Cartagena', image: 'https://api.sofascore.com/api/v1/player/1015257/image', contractEnd: '31/12/2026', marketValue: '€600k', team: 'Deportivo Maldonado', apiTeamId: 2370, isReserve: false, position: 'Volante central' },
  ...
  { shortName: 'N. Leguizamón', fullName: 'Nicolás Leguizamón', image: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQeiIZQqDWF9nZhEPfh1Y0WJTs1OFRuv-QGk0NEs4RElokHAw', contractEnd: null, marketValue: '€125k', team: 'Juan Pablo II', apiTeamId: 22479, isReserve: false },
  ...
  { shortName: 'J. Postigo', fullName: 'Joaquin Postigo', image: null, contractEnd: '31/12/2026', marketValue: '€75k', team: 'Acassuso', apiTeamId: 2425, isReserve: false },
  { shortName: 'D. Mastrángelo', fullName: 'Diego Mastrángelo', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3rOhvSjrXANyVmPAGDkjOPTid9lbwS5OGVjnB4lHe6rlzkA', contractEnd: '31/12/2026', marketValue: '€75k', team: 'Tristán Suárez', apiTeamId: 1965, isReserve: true },
...
export const AGENCY_OVERRIDES: AgencyOverride[] = [
  ...
  { name: 'Gonzalo González', team: 'Estudiantes Río Cuarto' },
]
