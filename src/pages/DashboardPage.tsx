              ...
              <>
                <div className="mt-1">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-xs text-apple-gray-500 dark:text-apple-gray-400">{t('dashboard.prom')}: {formatMarketValueInCurrency(kpis.totalPlayers > 0 ? displayTotal / kpis.totalPlayers : 0, currency, rate)}</span>
