-- Deduplica la lista por identidad real del jugador (transfermarkt_id) en vez de
-- nombre + club. Antes, un jugador con fila de API-Football y de Sofascore aparecia
-- dos veces cuando cada fila tenia un current_team_id distinto (1368 casos).
-- CREATE OR REPLACE: pisa la version anterior.
